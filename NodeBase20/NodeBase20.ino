...
void SendFrame()
{
  ...
  sendFrame[0].data_s8[4] = 0x1;
  sendFrame[0].data_s8[5] = 0x2;
  sendFrame[0].data_s8[6] = 0x3;
  sendFrame[0].data_s8[7] = 0x4;
  sendFrame[1].id = YAMURANODE_ID + 1;
  sendFrame[1].rtr = false;
  sendFrame[1].ext = false;
  sendFrame[1].len = 8;
  sendFrame[1].data_s8[0] = 0x5;
  sendFrame[1].data_s8[1] = 0x6;
  sendFrame[1].data_s8[2] = 0x7;
  sendFrame[1].data_s8[3] = 0x8;
  sendFrame[1].data_s8[4] = 0x9;
  sendFrame[1].data_s8[5] = 0xA;
  sendFrame[1].data_s8[6] = 0xB;
  sendFrame[1].data_s8[7] = 0xC;
  #ifdef DEBUG_VERBOSE
